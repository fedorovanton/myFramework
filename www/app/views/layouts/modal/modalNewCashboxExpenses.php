...
<div class="modal fade" id="modalNewCashboxExpenses" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Добавление расхода по кассе</h4>
            </div>

            <form role="form" enctype="multipart/form-data" action="cashboxExpensesNew" method="post">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <div class="form-group" id="place-for-document-load">
